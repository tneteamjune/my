# Generated by Django 3.1.2 on 2021-12-09 00:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meetingKey', models.CharField(default=common.models.hashKey, max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('meeting', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='common.meetingkey')),
